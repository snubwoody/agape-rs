...
// TODO move this to lib after converting to systems
...
mod test {
    ...
    fn init_context() {
        ...
        let ctx = Context::new(&widget,vec![]);
    ...
    fn hover_widget() {
        ...
        let mut ctx = Context::new(&widget,vec![]);
    ...
    fn click_widget() {
        ...
        let mut cx = Context::new(&widget,vec![]);
